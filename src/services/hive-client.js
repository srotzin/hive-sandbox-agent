...
const DID='did:hive:hiveforce-sandbox';const ID={name:'HiveForce-Sandbox',purpose:'Developer sandbox — safe testing environment, mock data, API playground, integration testing',capabilities:["sandbox_provision","mock_data","api_playground","integration_testing"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-sandbox-agent',purpose:ID.purpose})}
